...
INPUT_DIR=("/c/Users/ISHIDAVN035/Desktop" "/c/Users/ISHIDAVN035/Downloads")

number_of_dots=100

currentDate=$(date +%Y%m%d)
nameLog="${currentDate} - log.txt" #${currentDate}
...
sort() {
	...
	for (( i=0;i<${#list_file[@]};i++ )) ; do
		...
		if [[ ${list_file[i]} != ${__location} ]] ; then #Check folder isn't __location
